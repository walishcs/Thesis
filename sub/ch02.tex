...
\subsection{Ochiai (2016a)}

The main target of Ochiai's (\citeyear{ochiai2016buhwan}a) paper is to analyze the Bu-hwan vocabulary recorded by \textcite{bullock1874formosan} in comparison with Paran (equivalent to Tgdaya) Seediq and Taroko (equivalent to Eastern Truku) Seediq to elucidate the historical and linguistic relationships with other Seediq dialects.
...
\subsection{Cheng, Nanu Ruwiq, and Masaw Tadaw (2017) and Cheng, Dakis Pawan, and Pidu Nokan (2019)} \label{sec:cheng_sb}
...
\section{Relevant anthropological and sociological studies} \label{sec:anth_lit}
