...
\aikai{補一段研究問題，連接到下面的}

Based on the identified research gaps, this thesis sets three main goals to address the aforementioned research gaps and remained issues: (1) Reconstruct the phonological system of \acl{psed} and conduct a preliminary exploration of its morphosyntactic system and (2) Investigate the subgrouping of Seediq dialects based on the reconstruction of \acl{psed}.
