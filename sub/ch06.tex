...
In this chapter, solutions to reconstructing some lexical items with competing forms in Seediq dialets will also be first discussed in this section.
...
\section{Solutions to competing forms} \label{sec:external_lexical_evidence}
