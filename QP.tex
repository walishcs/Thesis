...
\usepackage{xspace}
\newcommand{\acs{pan}}{\textsc{PAn}\xspace}
\newcommand{\acl{pan}}{Proto-Austronesian\xspace}
...
\section*{List of Abbreviations}
    ...
    \item[ ] \acs{pan} = Proto-Austronesian
...
All \acs{pan} data for comparing purpose are from \textcite{ACD}. Note that the symbol use of *e [ə] will be changed to *ə in this paper. \acl{pata} forms are mainly from \textcite{goderich2020phd}, exceptions will be mentioned later in the paper.  
...
This paper will be organized as follows. Section 2 shows a review of previous studies on the Seediq language, especially those about reconstructions and internal classifications. Section 3 discuss the phonological systems of Seediq dialects in a synchronic aspect. Section 4 focus on the reconstruction of \acl{psed} phonology. Section 5 presents a Seediq subgrouping hypothesis based on linguistic evidence. Section 6 discusses some issues on lexical reconstruction. Section 7 discusses the \acl{psed} reflexes of \acl{pan} segments and related issues. Lastly, section 8 is for the conclusion, including a summary and remaining issues for future studies. 
...
This can be also seen in the reflexes of \acs{pan} *R in \acl{psed} as *g and *r. I will discuss this irregularity later in Section 7.2.5.
...
The words that contain word-medial *x are also rare. Also, those words are usually related to the meaning of `one', including *təxal `once', *taxa `one person', *maxal `ten', etc. These words are all with fossilized *-xa- or *-əxa- sequences, which are supposed to be related to \acs{pan} *əsa `one'. 
...
In Table \ref{tab:gender3}, we can observe many doublet combinations where one source comes from \acl{pan}, accompanied by another more innovative form. For example, \acs{pan} *qudaS > \acl{psed} *qudas and *qud-i `gray hair'; \acs{pan} *laŋaw `housefly' > \acl{psed} *raŋaw `blowfly' and *rəŋ-ədi `housefly'; \acs{pan} *wiRi > \acl{psed} *igi and *i-ril `left'; \acs{pan} *uka > \acl{psed} *uka and *u-ŋat `not exist.'
...
In addition, there are some more conservative forms can be found only in Seediq based on the current study, such as \acl{psed} *igi `left'. This word is clearly from \acs{pan} *(w)iRi, and the other derived form in \acl{psed} is *iril, which has a corresponding form: *ʔiɹil in Proto-Atayal. However, Proto-Atayal does not keep the female form *ʔigiʔ. 
...
*libu    & tibu     & tibu         & libu    & libu    & `pigsty'                              & \makecell[l]{\acs{pan} *Nibu `lair; den'\\\pata *libuʔ `coop; sty;\\pen'} \\
...
I will first discuss the regular reflexes, while the irregular examples and their possible causes will be presented later in this section. The regular reflexes of \acs{pan} consonants in \acl{psed} are shown in Table \ref{tab:refC}. The reflexes of vowels will be presented in Table \ref{tab:refV}.

\begin{spacing}{1.15}
\begin{longtable}[c]{lll}
\caption{\acl{psed} reflexes of \acl{pan} consonants}
\label{tab:refC}\\
\hline
\acs{pan} & \acl{psed}       & Examples                                                                                                                                                                                                       \\ \hline
\endfirsthead
%
\endhead
%
*p   & *p-/-p-/-k  & \begin{tabular}[c]{@{}l@{}}\acs{pan} *pitu > \psed *mə-pitu `seven'\\ \acs{pan} *Səpat > \psed *səpat `four'\\ \acs{pan} *Səyup > \psed *iyuk `to blow'\end{tabular}                                                         \\ \hline
*t   & *t          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *təlu > \psed *təru `three'\\ \acs{pan} *ita > \psed *ita `\textsc{1pl.incl}'\\ \acs{pan} *waqit > \psed *waqit `canine tooth'\end{tabular}                                                      \\ \hline
*C   & *c-/-c-?/-t & \begin{tabular}[c]{@{}l@{}}\acs{pan} *Capaŋ > \psed *capaŋ `patch on clothes'\\ \acs{pan} *huRaC > \psed *urat `tendon; blood vessel'\end{tabular}                                                                      \\ \hline
*k   & *k          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *kalih > \psed *kari `to dig'\\ \acs{pan} *baki > \psed *baki `grandfather'\\ \acs{pan} *buSuk > \psed *bəsuk-an `drunk'\end{tabular}                                                   \\ \hline
*q   & *q          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *qabu > \psed *qəbulit `ashes'\\ \acs{pan} *waqit > \psed *waqit `canine tooth'\\ \acs{pan} *utaq > \psed *utaq `vomit'\end{tabular}                                                    \\ \hline
*b   & *b-/-b-/-k  & \begin{tabular}[c]{@{}l@{}}\acs{pan} *batu(x) > \psed *bətunux `stone'\\ \acs{pan} *babuy > \psed *babuy `pig'\\ \acs{pan} *Suab > \psed *suwak `yawn'\end{tabular}                                                          \\ \hline
*z   & *d          & \acs{pan} *ma-azaNih > \psed *dalih `near'                                                                                                                                                                         \\ \hline
*d   & *d-/-d-/-t  & \begin{tabular}[c]{@{}l@{}}\acs{pan} *daya > \psed *daya `uphill'\\ \acs{pan} *adaS > \psed *adas `to bring'\\ \acs{pan} *lahud > \psed *rahut `downhill'\end{tabular}                                                       \\ \hline
*j   & *-y-        & \acs{pan} *pajay > \psed *payay `riceplant'                                                                                                                                                                        \\ \hline
*g?  & *k?         & \begin{tabular}[c]{@{}l@{}}\acs{pan} *gaRaŋ > \psed *karaŋ `crab'\\ \acs{pan} *tagəRaŋ > \psed *təkəraŋ `ribs'\end{tabular}                                                                                             \\ \hline
*m   & *m-/-m-/-ŋ  & \begin{tabular}[c]{@{}l@{}}\acs{pan} *mujiŋ `face' > \psed *muhiŋ `nose'\\ \acs{pan} *ima > \psed *ima `who'\\ \acs{pan} *qaRəm > \psed *aruŋ `pangolin'\end{tabular}                                                        \\ \hline
*n   & *n          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *naNaq > \psed *nalaq `pus'\\ \acs{pan} *tinun > \psed *tinun `to weave'\\ \acs{pan} *ŋajan > \psed *ŋayan `name'\end{tabular}                                                          \\ \hline
*ŋ   & *ŋ          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *ŋajan > \psed *ŋayan `name'\\ \acs{pan} *Naŋuy > \psed *laŋuy `to swim'\\ \acs{pan} *Capaŋ > \psed *capaŋ `patch on clothes'\end{tabular}                                              \\ \hline
*s   & *h or *x?   & \begin{tabular}[c]{@{}l@{}}\acs{pan} *siRa > \psed *cə-higa `yesterday'\\ \acs{pan} *basuq > \psed *bahu `to wash clothes'\\ \acs{pan} *əsa `one' > \psed *t-əxa-l `once'\end{tabular}                                       \\ \hline
*S   & *s          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *Sauni > \psed *sawni `just now'\\ \acs{pan} *uSa > \psed *usa `to go'\end{tabular}                                                                                                \\ \hline
*h   & *h or ∅     & \begin{tabular}[c]{@{}l@{}}\acs{pan} *huRaC > \psed *urat `tendon; blood vessel'\\ \acs{pan} *lahud > \psed *rahut `downhill'\\ \acs{pan} *baRah > \psed *bagah `charcoal'\\ \acs{pan} *kalih > \psed *kari `to dig'\end{tabular} \\ \hline
*N   & *l          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *Naŋuy > \psed *laŋuy `to swim'\\ \acs{pan} *paNid > \psed *palit `wings'\\ \acs{pan} *SiSiN > \psed *sisil `Grey-cheeked fulvetta (omen bird)'\end{tabular}                            \\ \hline
*l   & *r          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *lahud > \psed *rahut `downhill'\\ \acs{pan} *walay > \psed *waray `thread'\\ \acs{pan} *biqel > \psed *biqir `goiter'\end{tabular}                                                     \\ \hline
*R   & *g          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *RamiS > \psed *gamil `root'\\ \acs{pan} *baRah > \psed *bagah `charcoal'\\ \acs{pan} *SipuR > \psed *səpug `to count'\end{tabular}                                                      \\ \hline
*w   & *w          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *walay > \psed *waray `thread'\\ \acs{pan} *kawaS > \psed *kawas `year'\\ \acs{pan} *babaw > \psed *babaw `on; above'\end{tabular}                                                      \\ \hline
*y   & *y          & \begin{tabular}[c]{@{}l@{}}\acs{pan} *daya > \psed *daya `uphill'\\ \acs{pan} *pajay > \psed *payay `riceplant'\end{tabular}                                                                                            \\ \hline
\end{longtable}

\begin{longtable}[c]{ccccl}
\caption{\acl{psed} reflexes of \acl{pan} vowels}
\label{tab:refV}\\
\hline
\multirow{2}{*}{\acs{pan}} & \multicolumn{3}{c}{\acl{psed}}            & \multirow{2}{*}{Examples}                                                                                     \\ \cline{2-4}
...
\endlastfoot
%
*a                    & *ə             & *a          & *a    & \acs{pan} *ama(x) > \psed *tama `father'                                                                           \\
*i                    & *ə             & *i          & *i    & \acs{pan} *wiRi > \psed *igi `left'                                                                                \\
*u                    & *ə             & *u          & *u    & \acs{pan} *Nutud > \psed *lutut `to join together'                                                          \\
*ə                    & *ə             & *ə          & *u    & \begin{tabular}[c]{@{}l@{}}\acs{pan} *təlu > \psed *təru `three'\\ \acs{pan} *luSəq > \psed *rusuq `tears'\end{tabular} \\ \hline
\end{longtable}
\end{spacing}
...
Therefore, \acs{pan} *p and *b merge into \acl{psed} *k in word-final positions, while *t and *d are reflected as *t. Additionally, all labial sounds are reflected as their velar correspondents in such a position.

Additionally, the *j in \acs{pan} is regularly reflected as *y in \acl{psed}, with some exceptions probably due to borrowing. According to \textcite{song2023Aicgprime}, it is noted that the reflex of *j in \acl{psed} is *y, while in Pre-Proto-Atayal it is **g. Based on this correspondence, the *j in Proto-Atayalic can be reconstructed. The sound change *j > *y occurs from Proto-Atayalic to \acl{psed}. Table \ref{tab:panjref} presents the reflex of \acs{pan} *j in \acl{psed}. Note that only word-medial cases can be found, since word-initial *j- is banned in \acs{pan}, and word-final *-j is relatively rare. 

\begin{table}[!htbp]
\centering
\caption{\acl{psed} reflexes of \acs{pan} *j}
\label{tab:panjref}
\begin{tabular}{ccl}
\hline
\acs{pan}              & \acl{psed}                       & Gloss                 \\ \hline
...
The phoneme *g in \acs{pan} is highly controversial, but nonetheless, if we have to identify its reflex in \acl{psed}, it would be *k. For example, \acs{pan} *gaRaŋ > \psed *karaŋ `crab,' and \acs{pan} *tagəRaŋ > \psed *təkəraŋ `ribs.'

Next, there are two cases that are difficult to determine that which reflex is regular, or they may represent some kind of free variation. The first set is \acs{pan} *s, which is reflected as \acl{psed} *h or *x. The reflecting of \acs{pan} *s as *h is quite regular, but there is also a case where it is reflected as *x, as seen in the example of \acs{pan} root *əsa `one.'

\acs{pan} *əsa is reflected as a bound root *-(ə)xa- in \psed. For example, \psed *maxal `ten', and *təxal `once', which are both related to the meaning `one.' 

In fact, the origin of *x in Seediq or in the higher level of Proto-Atayalic is a mystery, also as mentioned by \textcite[263]{li1981paic}. \textcite[144]{goderich2020phd} argues that the Proto-Atayalic and Proto-Atayal word-final *-x reflects \acs{pan} *s, but he does not provide many examples. The only possible example mentioned is \acs{pan} *Sipəs > Proto-Atayal *hipux `cockroach.' However, the reflexes of this etymology in various Formosan languages often shows inconsistencies. Thus, the \acs{pan} reconstruction *Sipəs is quite questionable.

From the evidence we have from Atayal, it appears that there is a possibility that \acs{pan} *s could be reflected as *x in Atayal or Seediq. For example, \acs{pan} *asu is reflected as \pata *xu-ɹil (\psed *hu-liŋ), meaning `dog', and \acs{pan} *susu is reflected as Matu'uwal Atayal \textit{xuxuʔ}, meaning `breast.' In Atayal, there are also reflexes related to \acs{pan} *əsa, such as Squliq \textit{təxal}, meaning `again.'

Certainly, these examples are quite rare, but they are still related to the etyma from \acs{pan} and are difficult to explain as loanwords. Since other languages do not reflect \acs{pan} *s as /x/. In \acl{psed}, there are indeed many instances of word-final *-x, but none of them can be directly linked to any phoneme in \acs{pan}. At the same time, this may be related to the development of the ``Gender Register System'' in Atayalic, as seen in the example of \acs{pan} *batu > \psed *bətu-nux `stone.'

It is currently difficult to explain why \acs{pan} *s is reflected as *h and *x in \acl{psed}. It is possible that they represent as free variations or allophones at a certain stage. For now, I will consider both as regular reflexes.

Another case that is difficult to determine is the reflexes of \acs{pan} *h. In \acl{psed}, we can observe two types of reflexes, either as ∅ or as *h. Table \ref{tab:panhref} shows the reflexes of \acs{pan} *h in \acl{psed}. 

\begin{table}[!htbp]
\centering
\caption{\acl{psed} reflexes of \acs{pan} *h}
\label{tab:panhref}
\begin{tabular}{ccl}
\hline
\acs{pan}     & \acl{psed}         & Gloss                  \\ \hline
...
The only word-initial example is \acs{pan} *huRaC, which is reflected as \acl{psed} *urat. However, this example does not rule out the possibility of borrowing. The three word-medial and the word-final examples, except for *kalih, all show \acl{psed} *h. Therefore, we may consider *h to have a higher likelihood of being a regular reflex. 

\subsection{Irregular reflexes}

There are some \acs{pan} phonemes in \acl{psed} that exhibit interesting and irregular reflexes, worthy of mention. I have named these instances of irregular reflexes as the following five ``problems'': (1) the ``DC'' problem; (2) the ``SH'' problem; (3) the ``CLS'' problem; (4) the ``LD'' problem; and (5) the ``GR'' problem. This naming approach is inspired by the names ``the RGH law'' and ``the RLD law'' in previous studies on the reflexes of \acs{pan} *R and *j among Austronesian languages. However, these cases in \acl{psed} cannot be regarded as ``laws,'' so I have designated them as ``problems.''
...
\begin{tabular}{cccc}
\hline
Type                                 & \acs{pan}    & \acl{psed} (regular) & \acl{psed} (irregular)  \\ \hline
...
The ``DC'' problem refers to the phenomenon in \acl{psed} where the \acs{pan} *d is reflected as *c, in addition to the regular *d reflex. However, this phenomenon can be more reliably observed only in word-initial and word-medial positions, as these sounds merge as *t in word-final positions.

Table \ref{tab:dc} shows the examples of \acs{pan} *d > \acl{psed} *c, with Proto-Atayal from \textcite{goderich2020phd} for comparison (\acs{pan} *z/d > \pata *r). 
...
\begin{tabular}{cccc}
\hline
\acs{pan}     & \acl{psed} & Proto-Atayal & Gloss                      \\ \hline
...
When encountering such irregular reflexes, it is natural to consider the possibility of borrowings. First, we might attempt to explain them using this approach. The Formosan languages that mainly reflect \acs{pan} *z/d as /ʦ/ are Tsou and Kanakanavu. 

For `camphor tree', Tsou has \textit{cʔósɨ}, Kanakanavu has \textit{cakɨ́sɨ}; for `bean', Tsou \textit{recŋi}, Kanakanavu \textit{ʔaricaŋ}. The reflexes for \acs{pan} *damaR cannot be found in these two languages. The other possibility is Siraya. At least one Siraya dialect reflected \acs{pan} *d as \textit{s}, which is possible that there is an intermediate stage **c between *d and \textit{s}.
...
\setlength\itemsep{0em}
    ...
    \item  The irregular sound correspondences of some cognates between Seediq and Atayal (but without a \acs{pan} etymon, i.e. Atayalic lexical innovation).
\end{enumerate}
...
\hline
\acs{pan}           & \acl{psed}    & \acs{tg} & \acs{cto} & \acs{ctr} & \acs{etr} & Gloss                \\ \hline
...
The ``GR'' problem refers to the regular reflex of \acs{pan} *R as *g and the irregular reflex as *r in \acl{psed}. It is also considered the most confusing one among the five problems, as the two reflexes are relatively balanced in terms of frequency.

As described in Section 4.1, the correspondence between /g/ and /r/ in different Seediq dialects appears to be unstable. This phenomenon is also observed from \acs{pan} to \acl{psed}. However, the \acs{pan} to \acl{psed} situation is even more complex. In addition to sporadic changes such as those observed from \acl{psed} to Seediq dialects, there may be a significant proportion of words that have been borrowed from other languages.

Table \ref{tab:gr} presents examples of the reflection of \acs{pan} *R as \acl{psed} *r. In these examples, all dialects consistently reflect it as /r/. Therefore, based on a bottom-up approach, it is reconstructed as *r in the \acl{psed} stage.
...
\caption{Possible loanwords in the context of \acs{pan} *R > \acl{psed} *r}
\label{tab:gr2}\\
\hline
Gloss         & \acs{pan}            & \psed                  & Potential source                                       \\ \hline
\endfirsthead
%
\endhead
%
...
\hline
\acs{pan}   &  \acs{tg}  & \acs{cto}   & \acs{ctr}    & \acs{etr}  & Gloss         \\ \hline
...
Finally, this paper has compiled the reflexes from \acl{pan} to \acl{psed}, including regular and irregular examples. Among them, I presented the so-called ``Five Problems,'' namely the ``DC'' problem, the ``SH'' problem, the ``CLS'' problem, the ``LD'' problem, and the ``GR'' problem. The reasons behind these problems are diverse, including language contact, regional irregular sound changes, possible phonetic perceptual issues, and some may be related to the Gender Register System. However, there are still some puzzling and mysterious examples that remain unexplained at the moment.
